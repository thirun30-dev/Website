    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md">
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden max-h-[calc(90vh-52px)]">
          ...
          {/* ── LEFT: Domains + Rules ── */}
          <div
            className="w-full lg:w-[55%] p-5 sm:p-6 space-y-6 lg:overflow-y-auto overflow-y-visible shrink-0 lg:shrink border-b lg:border-b-0 lg:border-r"
          ...
          <div className="w-full lg:w-[45%] p-5 sm:p-6 flex flex-col lg:overflow-y-auto lg:max-h-[calc(90vh-52px)] shrink-0 lg:shrink">
            {submitted ? (
